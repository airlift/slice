        ...
        implements Comparable<Slice>
{
    ...
    public void getBytes(int index, Slice destination, int destinationIndex, int length)
    {
        MemorySegment.copy(
                ...
                MemorySegment.ofArray(destination.base), destination.baseOffset + destinationIndex, length);
    }
    ...
    public void getBytes(int index, byte[] destination, int destinationIndex, int length)
    {
        MemorySegment.copy(
                MemorySegment.ofArray(base), baseOffset + index,
                MemorySegment.ofArray(destination), destinationIndex, length);
    }
    ...
    {
        MemorySegment.copy(MemorySegment.ofArray(base), index, MemorySegment.ofArray(destination), (long) destinationIndex * Short.BYTES, (long) length * Short.BYTES);
    }
    ...
    {
        MemorySegment.copy(MemorySegment.ofArray(base), index, MemorySegment.ofArray(destination), (long) destinationIndex * Integer.BYTES, (long) length * Integer.BYTES);
    }
    ...
    {
        MemorySegment.copy(MemorySegment.ofArray(base), index, MemorySegment.ofArray(destination), (long) destinationIndex * Long.BYTES, (long) length * Long.BYTES);
    }
    ...
    {
        MemorySegment.copy(MemorySegment.ofArray(base), index, MemorySegment.ofArray(destination), (long) destinationIndex * Float.BYTES, (long) length * Float.BYTES);
    }
    ...
    {
        MemorySegment.copy(MemorySegment.ofArray(base), index, MemorySegment.ofArray(destination), (long) destinationIndex * Double.BYTES, (long) length * Double.BYTES);
    }
    ...
    public void setBytes(int index, Slice source, int sourceIndex, int length)
    {
        MemorySegment.copy(
                ...
                MemorySegment.ofArray(base), baseOffset + index, length);
    }
    ...
    {
        MemorySegment.copy(MemorySegment.ofArray(source), (long) sourceIndex * Short.BYTES, MemorySegment.ofArray(base), index, (long) length * Short.BYTES);
    }
    ...
    {
        MemorySegment.copy(MemorySegment.ofArray(source), (long) sourceIndex * Integer.BYTES, MemorySegment.ofArray(base), index, (long) length * Integer.BYTES);
    }
    ...
    {
        MemorySegment.copy(MemorySegment.ofArray(source), (long) sourceIndex * Long.BYTES, MemorySegment.ofArray(base), index, (long) length * Long.BYTES);
    }
    ...
    {
        MemorySegment.copy(MemorySegment.ofArray(source), (long) sourceIndex * Float.BYTES, MemorySegment.ofArray(base), index, (long) length * Float.BYTES);
    }
    ...
    {
        MemorySegment.copy(MemorySegment.ofArray(source), (long) sourceIndex * Double.BYTES, MemorySegment.ofArray(base), index, (long) length * Double.BYTES);
    }
