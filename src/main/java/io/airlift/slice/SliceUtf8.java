    ...
    private static void copyUtf8SequenceUnsafe(Slice source, int sourcePosition, Slice destination, int destinationPosition, int length)
    {
        switch (length) {
            ...
            case 3 -> {
                ...
                destination.setByte(destinationPosition + 2, source.getByte(sourcePosition + 2));
            }
            ...
            case 5 -> {
                ...
                destination.setByte(destinationPosition + 4, source.getByte(sourcePosition + 4));
            }
            case 6 -> {
                destination.setInt(destinationPosition, source.getInt(sourcePosition));
                destination.setShort(destinationPosition + 4, source.getShort(sourcePosition + 4));
            }
